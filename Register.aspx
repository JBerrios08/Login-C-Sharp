...
<body class="bg-dark text-light">
    <form id="formRegistro" runat="server" class="container-fluid min-vh-100 d-flex align-items-center justify-content-center">
                ...
                <div class="card bg-secondary border-0 shadow-lg">
                    <div class="card-body p-4">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-light-emphasis mb-0">Completa los siguientes datos para registrarte.</p>
                        </div>
